...
opt.dataset_path = "E:\Code\datasets\VOC2012toCOCO"  # COCO detection
# opt.dataset_path = r"D:\work\public_dataset\coco2017"  # Windows system
opt.backbone = "Darknet53"  # Darknet53、CSPDarknet、Res101、Res50
# opt.input_size = (640, 640)
opt.input_size = (1333, 800)
...
opt.test_size = (1333, 800)  # evaluate size
...
# opt.label_name = [      # voc2012转的coco格式
#     'dog', 'person', 'train', 'sofa', 'chair', 'car', 'pottedplant',
#     'diningtable', 'horse', 'cat', 'cow', 'bus', 'bicycle',
#     'motorbike', 'bird', 'tvmonitor', 'sheep', 'aeroplane', 'boat', 'bottle']
...
opt.basic_lr_per_img = 0.02 / 48.0
opt.scheduler = "yoloxwarmcos"
opt.no_aug_epochs = 2  # close mixup and mosaic augments in the last 15 epochs
opt.min_lr_ratio = 0.05
opt.weight_decay = 5e-4
opt.warmup_epochs = 2
opt.depth_wise = False  # depth_wise conv is used in 'CSPDarknet-nano'
opt.stride = [32]  # YOLOX down sample ratio: 8, 16, 32
...
opt.pretrain = False # pretrain model
